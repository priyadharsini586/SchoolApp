...
public class CalendarProperties {
    ...
    private Drawable mPreviousButtonSrc, mForwardButtonSrc,mEventDrawableSrc;
    ...
    public Drawable getEventDrawableSrc() {
        return mEventDrawableSrc;
    }

    public void setEventDrawableSrc(Drawable eventDrawableSrc) {
        mEventDrawableSrc = eventDrawableSrc;
    }

...
public class CalendarView extends LinearLayout {
    ...
    private void initCalendarProperties(TypedArray typedArray){
        ...
        Drawable eventBackgroundSrc = typedArray.getDrawable(R.styleable.CalendarView_eventDrawableBackgroundSrc);
        mCalendarProperties.setEventDrawableSrc(eventBackgroundSrc);
    }
